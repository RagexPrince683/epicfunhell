...
import ca.ragexprince.epicfunhell.items.ExplosiveArrowItem;
import ca.ragexprince.epicfunhell.items.FlamingArmorItem;
import ca.ragexprince.epicfunhell.items.FuelItem;
import ca.ragexprince.epicfunhell.items.TeleportStaff;
import ca.ragexprince.epicfunhell.util.ModArmorMaterial;
import ca.ragexprince.epicfunhell.util.ModItemTier;
